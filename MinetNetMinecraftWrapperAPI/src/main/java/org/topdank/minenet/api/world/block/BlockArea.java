...
public final class BlockArea implements Cloneable {
	...
	public BlockArea(BlockLocation corner1, BlockLocation corner2) {
		this(Math.min(corner1.getX(), corner2.getX()), Math.min(corner1.getY(), corner2.getY()), Math.min(corner1.getZ(), corner2.getZ()), Math.max(corner1.getX(), corner2.getX()) - Math.min(corner1.getX(), corner2.getX()), Math.max(
				corner1.getY(), corner2.getY()) - Math.min(corner1.getY(), corner2.getY()), Math.max(corner1.getZ(), corner2.getZ()) - Math.min(corner1.getZ(), corner2.getZ()));
	}
